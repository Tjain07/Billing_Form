...
import { sendDataToDoctorBackend } from '../api'; // Correct import path
...
const DoctorMasterForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        sendDataToDoctorBackend(dataToSend)
            .then(() => {
    ...
    return (
        <div>
            <h1 style={{ textAlign: "center", fontWeight: "bold" }}>Doctor Master Form</h1>
                    ...
                    <div className="left-section">
                        ...
                        <div className="form-group">
                            ...
                            >
                                ...
                                {formData.department && departmentOptions.find(option => option.value === formData.department)?.subDepartments.map(subDepartment => (
                                    <option key={subDepartment} value={subDepartment}>{subDepartment}</option>
                                ))}
                            </select>
                        </div>
                    </div>
